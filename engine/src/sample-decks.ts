 ...
 * a seat nobody brought their own deck to) and the client's deck builder
 * (offered as ready-made "starter decks" to play as-is or duplicate and
 * edit) — lives here, in the engine, so both share one source of truth
