...
const deckE = deck([
  ...
  ["Disa the Restless", 1],
  ["Anti-Venom, Horrifying Healer", 1],
  ["Judith, Carnage Connoisseur", 1],
  ["Thalia and The Gitrog Monster", 1],
  ["Arahbo, Roar of the World", 1],
  ["Ovika, Enigma Goliath", 1],
  ["Yuna, Grand Summoner", 1],
  ["Umbris, Fear Manifest", 1],
  ...
  ["Zndrsplt, Eye of Wisdom", 1],
  ["Katara, the Fearless", 1],
  ["Betor, Kin to All", 1],
  ["Nicol Bolas, the Ravager", 1],
  ["Quintorius, History Chaser", 1],
  ["Rocco, Cabaretti Caterer", 1],
  ["Roxanne, Starfall Savant", 1],
  ["Jodah, Archmage Eternal", 1],
  ["Kratos, God of War", 1],
  ["Mirko, Obsessive Theorist", 1],
  ["Rowan, Scion of War", 1],
  ["The Mycotyrant", 1],
  ["Wernog, Rider's Chaplain", 1],
  ["Toxrill, the Corrosive", 1],
  ["The Master of Keys", 1],
  ["Myrel, Shield of Argive", 1],
  ["Codie, Vociferous Codex", 1],
  ["Goro-Goro and Satoru", 1],
  ["Winter, Misanthropic Guide", 1],
  ["Ikra Shidiqi, the Usurper", 1],
  ["Cloud, Midgar Mercenary", 1],
  ["Szarel, Genesis Shepherd", 1],
  ...
  ["Tifa, Martial Artist", 1],
  ["Commodore Guff", 1],
  ["Bruce Banner", 1],
  ["Bruvac the Grandiloquent", 1],
  ["The Lord of Pain", 1],
  ["Evereth, Viceroy of Plunder", 1],
  ["Slinza, the Spiked Stampede", 1],
  ["Ezuri, Claw of Progress", 1],
  ["Bilbo, Birthday Celebrant", 1],
  ["Clive, Ifrit's Dominant", 1],
  ["Millicent, Restless Revenant", 1],
  ["Anowon, the Ruin Thief", 1],
  ["Hei Bai, Forest Guardian", 1],
  ["Kwain, Itinerant Meddler", 1],
  ["Jenova, Ancient Calamity", 1],
  ["Marisi, Breaker of the Coil", 1],
  ["Wayta, Trainer Prodigy", 1],
  ...
  ["Aang, at the Crossroads", 1],
  ["Aragorn, King of Gondor", 1],
  ["Sorin of House Markov", 1],
  ["Mr. Foxglove", 1],
  ["Narset, Enlightened Master", 1],
  ["Nine-Fingers Keene", 1],
  ["Loot, the Pathfinder", 1],
  ["Kelsien, the Plague", 1],
